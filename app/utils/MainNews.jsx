...
export const MainNews = ({ title, image, author, category, time, id }) => {
  return (
    <li
      id='MainNews'
      className='relative csm:m-0 m-1 cursor-pointer flex flex-col-reverse justify-between overflow-hidden rounded-lg border-gray-200 dark:border-slate-700 dark:bg-slate-700 csm:p-2 p-0 csm:flex-row csm:place-items-center csm:border-2'
    >
