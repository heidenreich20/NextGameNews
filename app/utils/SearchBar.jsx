...
const SearchBar = () => {
  ...
  return (
    <form className='flex justify-end items-center mx-2 sm:mx-4' onSubmit={handleSubmit}>
      <input onChange={handleChange} value={value} name='query' className='rounded-sm w-full dark:text-slate-800 py-0.5 px-1 font-semibold bg-slate-300 placeholder:text-slate-700' placeholder='Buscar...' />
