...
export const metadata: Metadata = {
  title: 'Análisis | Next Game News',
  description: 'Análisis profundos de los mejores videojuegos.',
}

export default async function AnalisisPage() {
  const { newsList, totalNewsCount } = await fetchNews({ type: 'Análisis', limit: 20 })
